"""
Django settings for late_snow_dev_92970 project.
...
ROOT_URLCONF = 'late_snow_dev_92970.urls'
...
WSGI_APPLICATION = 'late_snow_dev_92970.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_snow_dev_92970 API",
    "DESCRIPTION": "API documentation for late_snow_dev_92970 App",
    "VERSION": "v1",
}
